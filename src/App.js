...
function App() {
    const [icon , SetIcon ] = useState(<TbArrowBigDownLines className="btnNotActive"/>)
    ...
    function calculateAge(date) {
        ...
        SetIcon(<TbArrowBigDownLinesFilled  className="btnActive"/>)

        setTimeout(()=>{
            SetIcon(<TbArrowBigDownLines className="btnNotActive"/>)
            SetDataForm([
                {
                    name :"year",
                    value:years,
      ...
      <div className="container">
          <div className="w-full h-screen flex-center">
              ...
              <div className="w-full h-[65%]" >
                  <div className="box_container bg-white p-8 lg:p-24    ">
                      <form onSubmit={handleSubmit(onSubmit)} className="">
                          ...
                          <div className="h-[50px] my-[5rem] relative">
                              <hr/>
                              <button type="submit" className="btn_calc w-[100px] h-[100px]">{icon}</button>
                          </div>
                      </form>
